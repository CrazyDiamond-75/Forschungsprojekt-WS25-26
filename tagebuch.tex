...
\begin{document}
    ...
    \begin{timeline}
        30.10.25 & Beginn des Forschungsprojekts; Onboarding in die KIELER Infrastruktur. & 5 Stunden \\
        ...
        20.1.26 & Säubern des Codes für die Microlayout Berechnung; Implementierung der Navigation im \lstinline|SKGraph| für Knoten und Labels; Fixes & 4 Stunden \\
        ...
        23.2.26 & Arbeit am Forschungstagebuch sowie dem Forschungsbericht. & 6 Stunden \\
    \end{timeline}
    
    \noindent
    Somit ergibt sich insgesamt ein Zeitaufwand von 82 Stunden.
